    ...
    <>
      ...
      <style>{`
        ...
        .cp-eyebrow::before {
          ...
          width: 36px;
          height: 1px;
          background: linear-gradient(90deg, transparent, #d47828);
        }
        ...
        .cp-eyebrow::after {
          ...
          width: 36px;
          height: 1px;
          background: linear-gradient(270deg, transparent, #d47828);
        }
        ...
        .cp-divider-line {
          flex: 1;
          height: 1px;
          background: linear-gradient(90deg, transparent, rgba(212,120,40,0.42), transparent);
        }
        ...
        .cp-cc {
          ...
          width: 14px;
          height: 14px;
          border-color: rgba(212,120,40,0.3);
          border-style: solid;
        }
        ...
        @keyframes cpPulse {
          0%, 100% {
            box-shadow: 0 0 34px rgba(212,120,40,0.16);
          }

          50% {
            box-shadow: 0 0 52px rgba(212,120,40,0.32);
          }
        }
        ...
        .cp-info-icon {
          ...
          color: #d47828;
          font-size: 14px;
          background: rgba(212,120,40,0.04);
          transition: all 0.3s;
        }

        .cp-info-item:hover .cp-info-icon {
          border-color: rgba(212,120,40,0.52);
          box-shadow: 0 0 14px rgba(212,120,40,0.16);
        }
        ...
        .cp-social-label {
          ...
          letter-spacing: 0.3em;
          text-transform: uppercase;
          color: rgba(212,120,40,0.32);
        }

        .cp-social-sep {
          width: 1px;
          height: 18px;
          background: rgba(212,120,40,0.14);
        }
        ...
        .cp-social-link {
          ...
          font-size: 13px;
          transition: all 0.35s ease;
          background: rgba(212,120,40,0.03);
        }

        .cp-social-link:hover {
          border-color: #d47828;
          color: #d47828;
          box-shadow: 0 0 18px rgba(212,120,40,0.26);
        ...
        @media (max-width: 768px) {
          ...
          .cp-info-item {
            ...
            border-radius: 16px;
            background: rgba(212,120,40,0.035);
          }
      ...
      <div className="cp-page">
        ...
        <div className="cp-main">
          <div
            className={`cp-reveal ${visible ? "on" : "off"}`}
          ...
          >
            <p className="cp-subhead">
              We are here to answer your questions, hear your thoughts, and
              share secrets reserved for the initiated.
            </p>
          </div>
          ...
          >
            <div className="cp-card">
              <div className="cp-cc tl" />
              <div className="cp-cc tr" />
              <div className="cp-cc bl" />
              <div className="cp-cc br" />
          ...
          <div
            className={`cp-reveal ${visible ? "on" : "off"}`}
            style={{ transitionDelay: "520ms", width: "100%", maxWidth: "620px" }}
          >
