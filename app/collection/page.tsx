...
const SERIES_DATA: Series[] = [
  {
    ...
    status: "Complete",
    books: 4,
    desc: "A dark empire of forbidden love and ancient curses.",
  },
  {
    id: "midnight",
    ...
    status: "Ongoing",
    books: 3,
    desc: "Secrets echo through moonlit corridors of desire.",
  },
  {
    id: "crimson",
    ...
    status: "Ongoing",
    books: 2,
    desc: "Passion bleeds into power in a fractured kingdom.",
  },
  {
    id: "echoes",
    ...
    status: "Ongoing",
    books: 4,
    desc: "What was lost returns, but at what cost?",
  },
  {
    id: "veil",
    title: "Veil of Temptation",
    status: "Ongoing",
    books: 2,
    desc: "Behind every mask lies a truth too dangerous to face.",
  },
]
...
function EmberField({ mouse }: { mouse: React.MutableRefObject<[number, number]> }) {
  ...
  const [geometry, material] = useCallback(() => {
    ...
    for (let i = 0; i < PARTICLE_COUNT; i++) {
      ...
      const c =
        t < 0.6
          ? gold.clone().lerp(dim, Math.random() * 0.5)
          : t < 0.85
          ? amber.clone().lerp(white, Math.random() * 0.4)
...
export default function DarkFictionBookstore() {
  ...
  useEffect(() => {
    const obs = new IntersectionObserver(
      ([e]) => {
        if (e.isIntersecting) setIsRevealed(true)
      },
      { threshold: 0.15 }
    )
  ...
  const prevSlide = () => {
    ...
    setActiveSlide((p) => (p - 1 + activeBooks.length) % activeBooks.length)
  }

  const nextSlide = () => {
    if (activeBooks.length === 0) return
    setActiveSlide((p) => (p + 1) % activeBooks.length)
  }

  return (
    <div
      ref={sectionRef}
      className="relative min-h-screen w-full max-w-full overflow-x-hidden bg-black text-white"
    >
      <Navigation />
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 85% 80% at 50% 45%, transparent 15%, rgba(0,0,0,0.65) 65%, #000 100%)",
          }}
        />
      ...
      <div
        ref={heroRef}
        className="relative z-10 flex min-h-[75vh] flex-col items-center justify-center px-4 pt-24 text-center transition-opacity duration-1000 sm:px-6 md:px-8"
      >
        <p className="mb-5 text-xs font-semibold uppercase tracking-[0.34em] text-[#d47828] opacity-80 md:text-sm md:tracking-[0.4em]">
          The Story Collection
        </p>

        <h1 className="mb-6 font-display text-4xl font-bold leading-[0.95] tracking-tight sm:text-5xl md:text-6xl lg:text-8xl">
          Step Into a World of <br />
          <span className="text-[#d47828] italic lg:text-9xl">
            Shadows & Obsession
          </span>
        </h1>

        <p className="mb-10 max-w-xl text-sm leading-relaxed text-gray-400 md:mb-12 md:text-base">
          A curated shop of dark romantic series where every story is designed
          to captivate, seduce, and stay with you far beyond the final page.
        </p>

        <div className="flex flex-col gap-4 sm:flex-row sm:gap-5">
          <Link
            href="#series"
            className="rounded-full bg-[#d47828] px-8 py-4 font-semibold text-black transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_0_35px_rgba(212,120,40,0.6)] md:px-9"
          >
            Explore Collections
          </Link>
          ...
          <Link
            href="#latest"
            className="rounded-full border border-white/20 px-8 py-4 font-medium text-white transition-all duration-300 hover:-translate-y-1 hover:border-[#d47828] hover:text-[#d47828] md:px-9"
          >
            Latest Releases
          </Link>
        </div>
      ...
      <section
        id="series"
        className={`relative z-10 py-20 transition-all duration-700 md:py-24 ${
          isRevealed ? "translate-y-0 opacity-100" : "translate-y-12 opacity-0"
        }`}
      >
        <h2 className="mb-12 text-center font-display text-3xl tracking-tight sm:text-5xl md:mb-16 md:text-8xl">
              ...
              >
                <div className="relative z-10">
                  <div className="mb-5 flex items-center justify-between">
                    <span
                      className={`rounded-full border px-4 py-1.5 text-xs font-bold backdrop-blur-md ${
                        series.status === "Complete"
                          ? "border-emerald-500/30 bg-emerald-500/10 text-emerald-400"
                          : "border-[#d47828]/40 bg-[#d47828]/15 text-[#d47828]"
                      }`}
                    >
                    ...
                    <svg
                      className="h-5 w-5 text-[#d47828]/60"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
                  ...
                  <h3 className="mb-3 font-serif text-2xl font-bold leading-tight text-white md:text-3xl">
                    {series.title}
                  </h3>
      ...
      <section
        ref={booksSectionRef}
        className={`relative z-10 px-4 py-20 transition-all duration-500 md:px-8 md:py-24 ${
          activeSeries
      ...
      >
        <div className="mx-auto max-w-7xl">
          <button
            onClick={closeSeries}
            className="group mb-10 flex items-center gap-2 text-sm font-medium text-gray-400 transition-colors hover:text-[#d47828]"
          >
            <svg
          ...
          <h2 className="mb-12 text-center font-display text-3xl tracking-tight md:mb-16 md:text-5xl">
          ...
          {activeSeries && activeBooks.length > 0 && (
            <div className="relative flex min-h-[560px] items-center justify-center overflow-hidden px-2 sm:min-h-[620px] md:overflow-visible">
              ...
              <div className="slider-stage">
                {activeBooks.map((book, idx) => {
                  ...
                  if (isRight) {
                    tx = isMobile ? "42%" : "58%"
                    scale = isMobile ? "0.66" : "0.78"
                    zIdx = 20
                    opacity = isMobile ? "0.5" : "0.65"
                    blur = isMobile ? "1px" : "2px"
                  }
                  ...
                  return (
                    <div
                      ...
                      style={{
                        ...
                        transition:
                          "all 0.55s cubic-bezier(0.25,0.46,0.45,0.94)",
                    ...
                    >
                      <div className="relative w-full" style={{ aspectRatio: "2/3.2" }}>
                        ...
                        <div className="absolute right-4 top-4 flex h-9 w-9 items-center justify-center rounded-full border border-[#d47828]/60 bg-black/60">
                          <span className="text-xs font-bold text-[#d47828]">
                            {idx + 1}
                          </span>
                        </div>
                      </div>
                      ...
                      >
                        <h4 className="mb-5 font-display text-xl font-bold leading-snug text-white md:text-2xl">
                          {book.title}
                        </h4>

                        <div className="flex gap-3">
                          <button className="flex-1 rounded-xl bg-[#d47828] py-3 text-xs font-bold text-black transition-all hover:-translate-y-0.5 hover:shadow-[0_0_24px_rgba(212,120,40,0.5)]">
                            Read Now
                          </button>

                          <button className="flex-1 rounded-xl border border-white/20 py-3 text-xs font-medium text-white transition-all hover:-translate-y-0.5 hover:border-[#d47828] hover:text-[#d47828]">
                            Buy
                          </button>
                        </div>
                      </div>
              ...
              {activeBooks.map((_, i) => (
                <button
                  ...
                  style={{
                    ...
                    borderRadius: "4px",
                    background:
                      i === activeSlide ? "#d47828" : "rgba(212,120,40,0.25)",
                    border: "none",
                    cursor: "pointer",
                  }}
      ...
      {/* FOOTER */}
      <div className="relative z-10 mt-24 bg-gradient-to-t from-black via-black/95 to-transparent pt-16 pb-8">
        <Footer />
      </div>
      ...
      <style jsx global>{`
        ...
        .marquee-card {
          ...
          border: 1px solid rgba(212,120,40,0.12);
          border-radius: 28px;
          padding: 2.2rem;
          cursor: pointer;
        ...
        .marquee-card::before {
          ...
          position: absolute;
          inset: 0;
          background: radial-gradient(circle at top right, rgba(212,120,40,0.18), transparent 65%);
          opacity: 0;
        ...
        .marquee-card:hover {
          ...
          border-color: rgba(212,120,40,0.6);
          box-shadow:
            0 25px 60px rgba(0,0,0,0.6),
            0 0 40px rgba(212,120,40,0.25);
        }
        ...
        .slider-card {
          ...
          box-shadow:
            ...
            0 0 0 1px rgba(212,120,40,0.08);
          top: 0;
          left: 50%;
          margin-left: -50%;
        ...
        .slider-info {
          ...
          background: linear-gradient(to bottom, rgba(10,6,0,0.92), #000);
        }
        ...
        .slider-arrow {
          ...
          height: 48px;
          border-radius: 50%;
          border: 1px solid rgba(212,120,40,0.3);
        ...
        .slider-arrow:hover {
          border-color: #d47828;
          background: rgba(212,120,40,0.12);
          box-shadow: 0 0 20px rgba(212,120,40,0.3);
        }
